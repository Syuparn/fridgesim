...
import (
	...
	"github.com/syuparn/fridgesim/ent/migrate"
...
func (c *IngredientClient) UpdateOneID(id string) *IngredientUpdateOne {
...
func (c *IngredientClient) DeleteOneID(id string) *IngredientDeleteOne {
...
func (c *IngredientClient) Get(ctx context.Context, id string) (*Ingredient, error) {
	return c.Query().Where(ingredient.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *IngredientClient) GetX(ctx context.Context, id string) *Ingredient {
